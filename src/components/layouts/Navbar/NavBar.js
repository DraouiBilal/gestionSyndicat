              ...
              <div className="dropdown-list-content dropdown-list-message">
                <a href="#" className="dropdown-item">
                  ...
                  <span className="dropdown-item-desc">
                    ...
                    <span className="time text-primary">2 Min Ago</span>
                  </span>
                </a>
                <a href="#" className="dropdown-item">
                  <span className="dropdown-item-avatar text-white">
                  ...
                  <span className="dropdown-item-desc">
                    ...
                    <span className="time text-primary">5 Min Ago</span>
                  </span>
                </a>
                <a href="#" className="dropdown-item">
                  <span className="dropdown-item-avatar text-white">
                  ...
                  <span className="dropdown-item-desc">
                    ...
                    <span className="time text-primary">12 Min Ago</span>
                  </span>
                </a>
                <a href="#" className="dropdown-item">
                  <span className="dropdown-item-avatar text-white">
                  ...
                  <span className="dropdown-item-desc">
                    ...
                    <span className="time text-primary">30 Min Ago</span>
                  </span>
                </a>
                <a href="#" className="dropdown-item">
                  <span className="dropdown-item-avatar text-white">
                  ...
                  <span className="dropdown-item-desc">
                    ...
                    <span className="time text-primary">1 Days Ago</span>
                  </span>
                </a>
                <a href="#" className="dropdown-item">
                  <span className="dropdown-item-avatar text-white">
                  ...
                  <span className="dropdown-item-desc">
                    ...
                    <span className="time text-primary">2 Days Ago</span>
                  </span>
                </a>
              </div>
